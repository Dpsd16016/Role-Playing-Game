...
Αναφορικά με το teleport ακολούθησα οδηγίες εξωτερικής βοήθειας (βίντεο YouTube). Η τεχνική αυτή συνδέει 2 αντικείμενα Teleporters μεταξύ τους με χρήση κώδικα και Tag αλλά και αναγνώριση Player. Είναι τοποθετημένοι στη δεύτερη πίστα.

## Audio
Οι ήχοι που έβαλα ήταν αποκλειστικά 2D και όχι 3D spacial Sounds. Δε πιστεύω ότι θα πρόσθετε πολύ παραπάνω ουσία καθώς ήδη υπάρχουν αρκετοί ήχοι στο game: 
