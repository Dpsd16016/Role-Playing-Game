...
<img src="portrait.png" width="300"> <img src="frame.png" width="500"> <img src="bar.png" width="200">

## Score

Επειδή το score όπως προτείνεται δεν είχε ιδιαίτερο νόημα για το παιχνίδι μου, το μετέτρεψα αντ' αυτού σε μετρητή ηττημένων αντιπάλων που ανταποκρίνεται στο αντίστοιχο "Fix" του ρομπότ αλλά για μένα Samurai. Ακολούθησα εξωτερική βοήθεια (βίντεο YouTube) για να το πετύχω.
