...
Για να καλυφθούν οι απαιτήσεις του δεύτερου παραδοτέου έγινε προσθήκη κίνησης στους χαρακτήρες, ωστόσο ορισμένες από αυτές που προτείνει το tutorial π.χ. χορός του ρομπότ, αγνοήθηκαν ώστε να υπάρχει συνοχή με το θέμα. Οι κινήσεις είναι οι παρακάτω και αφορούν μόνο τις τέσσερεις βασικές κατευθύνσεις (Βοράς, Νότος, Ανατολή, Δύση).
...
- Strike (Η ένταξη του έμεινε ημιτελής καθώς δεν υποδικνύεται στο tutorial και έγινε με εξωτερική βόηθεια)
- Death (H ένταξη του δεν πραγματοποιήθηκε καθώς δεν είναι ακόμα απετούμενο και δεν υποδικνύεται στο tutorial)

Θα προστεθούν και όποιες άλλες απαραίτητες κινήσεις καθώς το παιχνίδι θα εξελήσεται στη διάρκεια του τρίτου παραδοτέου.

### Σημείωση
- Λόγω προβλημάτων με τις οδηγίες του tutorial αλλά και δυσκολίας εύρεσης κατάλληλου εξωτερικού υλικού κάποια από τα παραπάνω δεν έχουν ενταχθεί σωστά στο project ακόμα κάτι που πιστεύω θα ληθεί και με τη βοήθεια του καθηγητή.
...
Με γνώμονα το Concept ο κύριος χαρακτήρας δεν έχει projectile animation ως βασική επίθεση. Ήταν βέβαια μια αρχική σκέψη αλλά αποφάσισα να το αφήσω στην άκρη. Αντ'αυτού η βασική κίνηση είναι Melee attack κάτι που προσπάθησα να πετύχω με εξωτερική βοήθεια και ακόμα δεν είναι τελειοποιημένο.
