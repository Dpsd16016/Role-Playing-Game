...
- Ο πρώτος NPC είναι ένα δαιμόνιο που κρίβεται στο σκοτάδι από τις καλαμιές στο πάνω αριστερά μέρος της πρώτης πίστας.

Διάλογος: "Demon - by the end of your path toward revenge you and i will be the same"

<img src="DemonNPC.png" width="50">

- Ο δεύτερος NPC είναι μια στατική πλάγια όψη του τελικού κακού της ιστορίας ο οποίος εμφανίζεται μπροστά απο το εξωχικό σπίτι της δεύτερης πίστας.

Διάλογος: "Mysterious Man - Now then... Let me show you dispair"


<img src="MainAntagonistNPC.png" width="50">
