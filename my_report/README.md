...
Στη τεχνική του διαλόγου με κάποιον NPC επίσης ακολούθησα πιστά το tutorial και κατάφερα αισίως να δημιουργήσω 2 NPC, έναν ανά πίστα. Σχεδίασα δικό μου πλαίσιο διαλόγου και χαρακτήρες.
...
Αναφορικά με το teleport ακολούθησα οδηγίες εξωτερικής βοήθειας (βίντεο YouTube). Η τεχνική αυτή συνδέει 2 αντικείμενα Teleporters μεταξύ τους με χρήση κώδικα και Tag αλλά και αναγνώριση Player. Είναι τοποθετημένοι στη δεύτερη πίστα. Το σχέδιο είναι ένα λευκό λουλούδι μέσα σε μια μαύρη χωμάτινη τρύπα, το σχέδιο είναι πιο πολύ συμβολικό ως προς την έννοια της ελπίδας κάτι που ταιριάζει νοηματικά αφού ο teleporter αποτελεί διαφηγή από το κίνδυνο.
...
Το κύριο μενού αποτέλεσε όπως είχα πει από το παραδοτέο 1 το σχέδιο που είχα κάνει με μόνο διαφορά ότι οι επιλογές έγιναν stage 1 Και stage 2. Τα κουμπιά έγιναν με βοήθεια βίντεο και το κάθε ένα ανταποκρίνεται σε μια από τις 2 πίστες που έχω σχεδιάσει. Επίσης προστέθηκε τίτλος.
