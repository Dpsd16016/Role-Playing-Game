...
## Εκρεμμότητες
 ...
 Υπήρχαν μερικές εκκρεμότητες από το ***παραδοτέο 2*** που δυστυχώς δεν είχα καταφέρει να επιλύσω με εξωτερική βοήθεια. Ωστόσο κατάφερα να βρω τα υπολειπόμενα demo resources του tutorial και έτσι βρήκα πάλι ένα πάτημα ώστε να διορθώσω τα προβλήματα πάντα ακολουθώντας τα βήματα.

- [x]  Το ζήτημα της αποτυχίας Build διορθώθηκε.
- [x]  Το cinemachine φαίνεται κανονικά στο uploaded version.
