...
### Προβλήματα
Παρακάτω παραθέτω τα προβλήματα που εμπόδισαν την άρτια ολοκλήρωση του παραδοτέου και μια λίστα με στόχους προς επίληση με τη βοήθεια του καθηγητή μετα την επιστροφή απο τις διακοπές.
