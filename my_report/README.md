...
Σε αυτό το παραδοτέο έγινε προσθήκη ενός εχθρού με τη μορφή Samurai και η νέα μορφή του βασικού χαρακτήρα. Μετά από εξέταση in-game παρατηρήθηκε η ανάγκη για μια πιο απλή απεικόνιση δίοτι οι πολύ λεπτές γραμμές και κάποιες λεπτομέριες χαλάνε.
