...
Η δεύτερη πίστα είχα αποφασίσει εξ αρχής ότι θα ήταν boss room. Αν και υπήρξε ζήτημα με το χρόνο κατόρθωσα να ολοκληρώσω ένα λίγο διαφορετικό σχέδιο από ότι αρχικά είχα φανταστεί ωστόσο έχει την ίδια χρηστικότητα. Προστέθηκαν διακοσμητικές κολώνες.
