...
Στη τεχνική του διαλόγου με κάποιον NPC επίσης ακολούθησα πιστά το tutorial και κατάφερα αισίως να δημιουργήσω 3 NPC, έναν ανά πίστα. Σχεδίασα δικό μου πλαίσιο διαλόγου και χαρακτήρες. Ο διάλογος επιτυγχάνεται με το πάτημα του κουμπιού "X" κοντά στους NPC.
