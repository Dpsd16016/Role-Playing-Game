...
Στη τεχνική του διαλόγου με κάποιον NPC επίσης ακολούθησα πιστά το tutorial και κατάφερα αισίως να δημιουργήσω 2 NPC, έναν ανά πίστα. Σχεδίασα δικό μου πλαίσιο διαλόγου και χαρακτήρες. Ο διάλογος επιτυγχάνεται με το πάτημα του κουμπιού "X" κοντά στους NPC.

<img src="DialogueFrame.png" width="400">

- ***Ο πρώτος*** NPC είναι ένα δαιμόνιο που κρίβεται στο σκοτάδι από τις καλαμιές στο πάνω αριστερά μέρος της πρώτης πίστας. Ο συγκεκριμένος χαρακτήρας είναι επίτηδες μυστήριος και υπάρχει εκεί για να προβληματίσει το θεατή ότι κάτι δε πάει καλά με το μέρος.
...
Παρακάτω αναφέρονται όλα τα πράγματα που έγιναν εκτός των ζητουμένων των παραδοτέων σαν έξτρα βήματα προς ωραιοποίηση του αποτελέσματος.
...
!!Μια παρατήρη. Αν κάποιος πατήσει παύση, επιλέξει το αρχικό μενού και ύστερα πατήσει άλλη πίστα τότε μετά την εισαγωγή του στη πίστα, η εικόνα είναι ακόμα παγωμένη και πρέπει να πατήσει πάλι "esc".
...
# Σχόλια
- Ο συνολικός χρόνος σχεδιασμού των εικαστικών στοιχείων του project σύμφωνα με τη καταγραφή του procreate είναι: ***85.8 Ώρες***
...
Μεγάλη Δυσκολία: Μια από τις μεγαλύτερες δυσκολίες και ίσως η πιο επώδυνη είναι η διαδικασία της σύνδεσης και λειτουργίας των animation. Ο προγραμματισμός έχει έντονο το υποκειμενικό στοιχείο και πολλές φορές οι πολλές πηγές συγχίζουν αντί να βοηθούν.
