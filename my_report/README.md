...
- Ο σχεδιασμός του βασικού χαρακτήρα ήταν απλός. Όπως ανέφερα βάσισα την όψη του στο χαρακτήρα του πρώτου σχεδίου. Οι αναλογίες του σώματος in-game είναι αρκετά ρεαλιστικές και όχι το τυπικό δυσανάλογο πρότυπο που είναι συχνό σε παιχνίδια 2D. Έκανα αυτή την επιλογή επίτηδες για να μην αποσπά από το σοβαρό ύφος.
