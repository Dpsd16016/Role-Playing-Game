...
Σε αυτό το παραδοτέο έγινε προσθήκη ενός εχθρού με τη μορφή Samurai και η νέα μορφή του βασικού χαρακτήρα. Μετά από εξέταση in-game παρατηρήθηκε η ανάγκη για διόρθωση απεικόνιση π.χ. κάποιες λεπτές γραμμές χαλάγανε. Αν υπάρξει ανάγκη θα γίνουν περαιτέρω αλλαγές εν καιρό.

<img src="Ronin.png" width="200"> <img src="MainCharacter.png" width="150">

## Animation


Για να καλυφθούν οι ελάχιστες απαιτήσεις του παραδοτέου και για να υπάρχει συνοχή με το θέμα του παιχνιδιού ορισμένες κινήσεις που προτείνει το tutorial αγνοήθηκαν. Πλέον προσαρμοσμένο στα δεδομένα οι κινήσεις που προστέθηκαν είναι οι παρακάτω και αφορούν τις τέσσερεις βασικές κατευθύνσεις.
- Main Character: Walk, Strike, Death
- Opponent: Walk
