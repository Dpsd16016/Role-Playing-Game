...
- [x]  Η επίλυση του ρομπότ που ήταν **extra objective** προστέθηκε και αντ'αυτού ο εχθρός πέφτει στο πάτωμα.
- [x]  Ο βασικός χαρακτήρας πλέον έχει Idle θέση **σε κάθε** πλευρά.
