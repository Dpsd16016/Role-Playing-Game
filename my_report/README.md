...
- Ο συνολικός χρόνος ενασχόλησης με το προγραμματιστικό κομμάτι της εργασίας κατέληξε προσωπικά για εμένα (λόγω διάφορων προβλημάτων) να είναι ***πολύ περισσότερος απο τις προϋπολογισμένες 14 ώρες***.
